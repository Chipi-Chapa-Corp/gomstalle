...
var open_rotation_degrees := 0.0
var is_opened = false
var _applied_rotation_degrees := 0.0
...
func _physics_process(_delta: float) -> void:
	if is_equal_approx(_applied_rotation_degrees, open_rotation_degrees):
		return
	_applied_rotation_degrees = open_rotation_degrees
	_apply_rotation(open_rotation_degrees)
